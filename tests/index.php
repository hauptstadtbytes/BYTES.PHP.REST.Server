...
//$config->endpoints["/v1/hello"] = "BytesPhp\Rest\Server\Tests\CookBook\Endpoints\HelloEndpoint"; //is registered automatically by endpoint metadata (see BYTESPHP-26)
//$config->endpoints["/v1/info"] = "BytesPhp\Rest\Server\Tests\CookBook\Endpoints\InfoEndpoint"; //is registered automatically by endpoint metadata (see BYTESPHP-26)
